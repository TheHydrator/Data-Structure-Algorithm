...
//		System.arraycopy (args, 0, allArgs, length + 1, args.length);
	...
	static {
		String BIN_PATH = System.getProperty ("user.dir") + System.getProperty ("file.separator") + "bin";
		PREFIX_ARGS_FOR_VM = new ArrayList<> ();
		PREFIX_ARGS_FOR_VM.add ("-cp");
		PREFIX_ARGS_FOR_VM.add ("\"" 
...
/* private static */class CodeMap {
	...
	public void addFile (String filename) {
		...
		String srcFilename = "src" + File.separator + filename;
